package dev.teamcitrus.demeter.consumable;

import com.mojang.serialization.MapCodec;
import dev.teamcitrus.demeter.registry.ConsumeEffectRegistry;
...
public class ClearRandomNegativeEffect implements ConsumeEffect {
    ...
    public Type<? extends ConsumeEffect> getType() {
        return ConsumeEffectRegistry.CLEAR_RANDOM_NEGATIVE.get();
    }
