...
public class ItemRegistry {
    ...
    public static final DeferredItem<Item> MAPLE_SYRUP_BOTTLE = ITEMS.register("maple_syrup_bottle", () -> new Item(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).food(DemeterFoods.MAPLE_BOTTLE).usingConvertsTo(Items.GLASS_BOTTLE).stacksTo(16)));
    ...
    public static final DeferredItem<Item> MAPLE_SIGN = ITEMS.register("maple_sign", () -> new SignItem(new Item.Properties(), BlockRegistry.MAPLE_SIGN.get(), BlockRegistry.MAPLE_WALL_SIGN.get(), Direction.DOWN));
    ...
    public static final DeferredItem<Item> MAPLE_BOAT = ITEMS.register("maple_boat", () -> new BoatItem(EntityTypeRegistry.MAPLE_BOAT.get(), new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> MAPLE_CHEST_BOAT = ITEMS.register("maple_chest_boat", () -> new BoatItem(EntityTypeRegistry.MAPLE_CHEST_BOAT.get(), new Item.Properties().stacksTo(1)));
