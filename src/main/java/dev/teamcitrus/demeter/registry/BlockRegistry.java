...
public class BlockRegistry {
    ...
    public static final DeferredBlock<WallSignBlock> MAPLE_WALL_SIGN = BLOCKS.register("maple_wall_sign", () -> new WallSignBlock(MAPLE_WOOD_TYPE, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN).overrideLootTable(MAPLE_SIGN.get().getLootTable()).setId(createID("maple_wall_sign"))));
    ...
    public static final DeferredBlock<WallHangingSignBlock> MAPLE_WALL_HANGING_SIGN = BLOCKS.register("maple_wall_hanging_sign", () -> new WallHangingSignBlock(MAPLE_WOOD_TYPE, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN).overrideLootTable(MAPLE_HANGING_SIGN.get().getLootTable()).setId(createID("maple_wall_hanging_sign"))));
